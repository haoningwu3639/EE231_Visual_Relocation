...
#     parser.add_argument('--model', type=str, default = '/GPFS/data/haoningwu/HFNet/data/aachen/models/hfnet_model')
#     parser.add_argument('--eval_name', type=str, default = 'aachen_day')
#     parser.add_argument('--local_method', type=str, default = 'hfnet')
#     parser.add_argument('--global_method', type=str, default = 'hfnet')
